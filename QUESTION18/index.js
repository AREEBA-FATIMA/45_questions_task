...
var myFavPlaces = ["Turkey", "Indonesia", "Bangkok", "Switzerland", "New Zeeland", "Italy"];
console.log("Original Order :", myFavPlaces);
var sortedOrder = ["Turkey", "Indonesia", "Bangkok", "Switzerland", "New Zeeland", "Italy"];
...
console.log("Original Listt :", myFavPlaces);
myFavPlaces.sort();
console.log("Alphabetical Order :", myFavPlaces);
myFavPlaces.reverse();
console.log("Reverse Order", myFavPlaces);
